...
class GitHubReleasesCollector:
    """T1: Claude Code releases via GitHub Atom feed.
    ...
    def __init__(
        self,
        repo: str = "anthropics/claude-code",
        category: str = "claude-code",
    ) -> None:
        self.repo = repo
        self.category = category
        self.feed_url = f"https://github.com/{repo}/releases.atom"
        ...
        for entry in parsed.entries:
            ...
            articles.append(
                Article(
                    ...
                    meta={"repo": self.repo, "collector": self.name},
                )
            )
